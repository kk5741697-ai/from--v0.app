...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 py-16 lg:py-24 px-4 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-600 mb-12 lg:mb-16 max-w-4xl mx-auto leading-relaxed">
            ...
            {toolCategories.map((category) => (
              ...
              >
                <Button
                  ...
                  className={`px-6 lg:px-8 py-2 lg:py-3 rounded-full transition-all duration-300 font-semibold text-sm lg:text-base ${
                    category.active
            ...
            {featuredTools.map((tool) => {
              ...
              return (
                <Link
                  key={tool.title}
                  href={tool.href}
                  className="block bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 lg:p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer group hover:border-gray-300"
                >
                  {tool.isNew && (
                    <Badge className="mb-3 lg:mb-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white text-xs lg:text-sm font-semibold px-3 py-1 shadow-lg">
                      New!
                    </Badge>
                  )}
                  <div className={`inline-flex p-3 lg:p-4 rounded-2xl ${tool.iconBg} mb-4 lg:mb-6 group-hover:scale-125 transition-transform duration-300 shadow-lg group-hover:shadow-xl`}>
                    <Icon className={`h-6 w-6 lg:h-8 lg:w-8 ${tool.iconColor}`} />
                  </div>
                  <h3 className="font-heading font-bold text-lg lg:text-xl text-gray-900 mb-2 lg:mb-3 text-left group-hover:text-blue-600 transition-colors">
                    {tool.title}
                  </h3>
                  <p className="text-sm lg:text-base text-gray-600 text-left leading-relaxed">
                    {tool.description}
                  </p>
                </Link>
              )
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="text-center">
              <div className="bg-blue-100 p-3 lg:p-4 rounded-xl w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-4 flex items-center justify-center">
                <Zap className="h-6 w-6 lg:h-8 lg:w-8 text-blue-600" />
              </div>
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">Lightning Fast</h3>
            ...
            <div className="text-center">
              <div className="bg-green-100 p-3 lg:p-4 rounded-xl w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-4 flex items-center justify-center">
                <Lock className="h-6 w-6 lg:h-8 lg:w-8 text-green-600" />
              </div>
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">100% Secure</h3>
              <p className="text-sm lg:text-base text-gray-600">
            ...
            <div className="text-center">
              <div className="bg-purple-100 p-3 lg:p-4 rounded-xl w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-4 flex items-center justify-center">
                <Globe className="h-6 w-6 lg:h-8 lg:w-8 text-purple-600" />
              </div>
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">Always Available</h3>
              <p className="text-sm lg:text-base text-gray-600">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <Link href="/pdf-tools" className="group">
              <div className="bg-white rounded-xl p-4 lg:p-6 border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="bg-red-100 p-2 lg:p-3 rounded-xl w-10 h-10 lg:w-12 lg:h-12 mb-3 lg:mb-4 group-hover:scale-110 transition-transform">
                  <FileType className="h-6 w-6 lg:h-6 lg:w-6 text-red-600" />
                </div>
                <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">
                  PDF Tools
                </h3>
            ...
            <Link href="/image-tools" className="group">
              <div className="bg-white rounded-xl p-4 lg:p-6 border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="bg-blue-100 p-2 lg:p-3 rounded-xl w-10 h-10 lg:w-12 lg:h-12 mb-3 lg:mb-4 group-hover:scale-110 transition-transform">
                  <ImageIcon className="h-6 w-6 lg:h-6 lg:w-6 text-blue-600" />
                </div>
            ...
            <Link href="/qr-tools" className="group">
              <div className="bg-white rounded-xl p-4 lg:p-6 border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="bg-green-100 p-2 lg:p-3 rounded-xl w-10 h-10 lg:w-12 lg:h-12 mb-3 lg:mb-4 group-hover:scale-110 transition-transform">
                  <QrCode className="h-6 w-6 lg:h-6 lg:w-6 text-green-600" />
                </div>
                <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-2 group-hover:text-green-600 transition-colors">
                  QR & Barcode
                </h3>
                <p className="text-xs lg:text-sm text-gray-600 mb-2 lg:mb-3">
            ...
            <Link href="/text-tools" className="group">
              <div className="bg-white rounded-xl p-4 lg:p-6 border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="bg-yellow-100 p-2 lg:p-3 rounded-xl w-10 h-10 lg:w-12 lg:h-12 mb-3 lg:mb-4 group-hover:scale-110 transition-transform">
                  <Code className="h-6 w-6 lg:h-6 lg:w-6 text-yellow-600" />
                </div>
                <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-2 group-hover:text-yellow-600 transition-colors">
                  Code Tools
                </h3>
                <p className="text-xs lg:text-sm text-gray-600 mb-2 lg:mb-3">
      ...
      {/* CTA Section */}
      <section className="py-12 lg:py-16 px-4 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-6 lg:px-8">
              Get Started Free
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-6 lg:px-8">
              View All Tools
            </Button>
          </div>
        </div>
